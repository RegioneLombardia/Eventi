...
class SiteController extends Controller {
     ...
     */
    public function actionLogoutFrontend($redir = null)
    {
        Yii::$app->user->logout();
        ...
        if($redir){
            ...
            if (YII_ENV_PROD && !is_null($socialAuthModule) && ($socialAuthModule->enableSpid === true)) {
                ...
                $redirectspid = \yii\helpers\Url::to([
                    '/Shibboleth.sso/Logout',
                    'return' => 'https://idpcwrapper.crs.lombardia.it/PublisherMetadata/Logout?dest=' . urlencode($redir)]);
                return $this->redirect($redirectspid);
            }
