...
<head>
    ...
    $this->render(
        ...
        [
            'title' => (($isLuyaApplication && Yii::$app->isCmsApplication()) && !empty($this->params['titleSection'])) ? $this->params['titleSection']
                : $this->title
        ]
    );
    ?>
            ...
            <div class="page-content">
                <div class="<?= ($showSidebarForm) ? 'layout-sidebarForm' : 'layout-standardForm' ?>">
                    ...
                    <div class="<?= ($showSidebarForm) ? 'main-with-sidebar' : 'w-100' ?>">
                        ...
                        <?=  \open20\amos\events\widgets\ChangeLanguage::widget(); ?>
                        <?php \Yii::$app->language = 'en-GB';?>
                        <?= $content ?>
