...
if($model->status == \open20\amos\events\models\Event::EVENTS_WORKFLOW_STATUS_SUSPENDED){
...
//                                    'actionDelete' => "/events/event/delete?id=" . $model->id,
                ...
                <div class="cta-network-scope flexbox">
                    ...
                    <?php
                    $exitUrl = \open20\amos\events\utility\EventsUtility::getUrlLanding($model);
                    ?>
...
//                            }
                        ...
                        if ($userInList && (\Yii::$app->controller->module->id != 'community')) {
                            echo Html::a(
                                AmosEvents::t('amosevents', 'Event community') . AmosIcons::show('arrow-right'),
