...
if (!$hideUserMenu && !CurrentUser::isPlatformGuest()) {
    ...
    if (\Yii::$app->user->can('EVENT_DG_OPERATOR') || \Yii::$app->user->can('SUPER_USER_EVENT')) {
        /* dashboard */
        $dashboardLink = \Yii::$app->params['platform']['backendUrl'] . "/dashboard";
        $menuUser .= Html::tag(
            'li',
            Html::a(
                Html::tag('span', Yii::t('amoscore', "Accedi all'area riservata")),
                $dashboardLink,
                [
                    'class' => 'list-item p-0',
                    'title' => Yii::t('amoscore', "Accedi all'area riservata")
                ]
            ),
            [
                'class' => 'privacy-menu'
    ...
    /* i miei eventi */
    $myEventsLink = \Yii::$app->params['platform']['backendUrl'] . "/events/event-dashboard/my-events-home";
    $menuUser .= Html::tag(
        'li',
        Html::a(
            Html::tag('span', Yii::t('amoscore', 'I miei eventi')),
            $myEventsLink,
            [
                'class' => 'list-item p-0',
                'title' => Yii::t('amoscore', 'I miei eventi')
            ]
        ),
        [
            'class' => 'privacy-menu'
    ...
    } elseif ($isLuyaApplication && Yii::$app->isCmsApplication()) {
                            ...
                            <?php if (isset(\Yii::$app->params['toFrontendLink']) && \Yii::$app->params['toFrontendLink']) : ?>
                                <div class="nav-item">
                                    <a class="nav-link" href="<?= \Yii::$app->params['platform']['frontendUrl'] ?>" title="<?=
                                        ...
                                        <span style="font-size:14px; margin-left:4px; margin-top:2px"><?= Yii::t(
                                                                                                            'app',
                                                                                                            'VAI ALLA HOME'
                                                                                                        ) ?>
                                        </span>
