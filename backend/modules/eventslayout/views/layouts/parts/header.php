 ...
 */
?>
    <a href="#bk-page" id="skiplinks" class="btn btn-primary btn-lg sr-only sr-only-focusable"><?= \Yii::t('app', 'Salta al contenuto principale') ?></a>
...
//                $menuItems[] = $menuTranslation;
            ...
            if (isset(\Yii::$app->params['toFrontendLink']) && \Yii::$app->params['toFrontendLink']) {
                ...
                if (isset(\Yii::$app->params['toFrontendLinkNoBlank']) && \Yii::$app->params['toFrontendLinkNoBlank']) {
                    ...
                    $frontendLink = Html::tag('li',
                        Html::a(
                            AmosIcons::show('globe-alt') . Html::tag('p', Yii::t('site', 'VAI ALLA HOME'))
                            , Url::to(\Yii::$app->params['platform']['frontendUrl']),
                            ['title' => Yii::t('amoscore', 'Vai alla home di ' . Yii::$app->name), 'target' => '_blank']
                        ), ['class' => 'toFrontend']
                    );
                    $menuItems[] = $frontendLink;
                }
