...
$urlSocial = ($type == 'login') ? '/socialauth/social-auth/sign-in?provider=' : '/admin/security/register?social=';
...
if(!empty(\Yii::$app->request->get('redir'))){
    $paramsRedirectUrl.= '&redirectTo='.\Yii::$app->request->get('redir');
}
else {
    if ($communityId) {
