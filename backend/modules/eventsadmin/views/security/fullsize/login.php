...
<div id="bk-formDefaultLogin" class="loginContainerFullsize">
    ...
    <?php endif; ?>
    <?php if(!isset(\Yii::$app->params['hideLoginStandard'])){
        $hideLoginStangard  = true;
    }else {
        $hideLoginStangard =  \Yii::$app->params['hideLoginStandard']  ;
    }?>
    <?php if (!$hideLoginStangard) { ?>
        ...
        <div class="login-block col-xs-12 nop">
            ...
            <?php if (CoreCommonUtility::platformSeenFromHeadquarter() || !$adminModule->hideStandardLoginPageSection): ?>
                ...
                <div class="login-body">
                    <?= Html::tag('h2', AmosAdmin::t('amosadmin', '<strong>ACCEDI</strong> con username e password <span data-toggle="tooltip" data-placement="top" title="A partire dal 28 febbraio 2021, per accedere o registrarsi ai servizi online offerti dalle Pubbliche Amministrazioni, sarà necessario utilizzare esclusivamente: SPID (Sistema Pubblico di Identità Digitale), CIE (Carta di Identità Elettronica), CNS (Carta Nazionale dei Servizi" class="am am-info-outline"></span>'), ['class' => 'title-login col-xs-12 nop ']) ?>
                    <!--                <p>--><?php //"Accedi fino al 30 settembre 2021"?><!--</p>-->
                    <div class="row nom">
                        <?php if (CoreCommonUtility::platformSeenFromHeadquarter() || !$adminModule->hideStandardLoginPageSection) : ?>
                            <div class="col-xs-12 nop" style="border:1px solid; padding:15px 0;">
                ...
                <?php endif; ?>
                <div class="col-xs-12 rememberme">
