...
<section>
    ...
    <p>
        <?= Html::a('http://www.example.it', 'http://www.example.it') ?>.
    </p>
    <p>
    ...
    <p>
        <?= Yii::t('amosplatform', "Responsabili del trattamento sono Finlombarda S.p.A., che svolge attività e compiti strumentali e correlati alla fornitura del servizio e, Aria S.p.A., che svolge attività di gestione e manutenzione dei sistemi informativi per conto di Regione Lombardia.") ?>
    </p>
    <p>
