...
class Nav extends \luya\cms\models\Nav
{
    ...
    {
        //override per bypassare la re-indicizzazione che nel nostro caso fan capo allo stesso container e con parent
        //sempre a 0 e quindi aggiornerebbe tutta la tabella
    }
}