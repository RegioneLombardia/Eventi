...
class CmsEventLandingPageBlock extends CmsPageBlock
{
    ...
    {
        $id_block = static::findBlock(CmsBlocksBuilder::EVENTLANDING);
        $blocks   = static::find()->
