 ...
 *
 * @property \amos\userimporter\models\UserImportTask $userImportTask
 */
class  UserImportTaskUser extends \open20\amos\core\record\Record
{
    ...
    {
        return [
            [['mailup_import_id', 'to_send','user_import_task_id', 'created_by', 'updated_by', 'deleted_by','user_id'], 'integer'],
    ...
    {
        return $this->hasOne(\amos\userimporter\models\UserImportTask::className(), ['id' => 'user_import_task_id']);
    }
}
