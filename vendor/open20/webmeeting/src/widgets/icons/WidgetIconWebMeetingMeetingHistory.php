...
class WidgetIconWebMeetingMeetingHistory extends WidgetIcon
{
    /**
     * @inheritdoc
     */
    public function init()
    {
        ...
        $this->setLabel(WebMeetingModule::_tHtml('#webmeeting_webmeeting_history'));
        $this->setDescription(WebMeetingModule::_t('#webmeeting_widget_meeting_history'));
        ...
        $this->setUrl(WebMeetingModule::getMyIndexLink('-history'));
