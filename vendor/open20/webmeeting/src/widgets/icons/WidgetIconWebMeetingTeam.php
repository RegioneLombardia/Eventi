 ...
 * 
 */
class WidgetIconWebMeetingTeam extends WidgetIcon
{
    /**
     * @inheritdoc
     */
    public function init()
    {
        ...
        $this->setLabel(WebMeetingModule::_tHtml('#webmeeting_team'));
        $this->setDescription(WebMeetingModule::_t('#webmeeting_widget_team'));
        ...
        $this->setUrl(WebMeetingModule::getMyIndexLink('-team'));
