...
use open20\webmeeting\widgets\icons\WidgetIconWebMeetingMeetingHistory;
 ...
 * @inheritdoc
 */
class m210203_170007_create_webmeeting_history_widget extends Migration
{
    /**
     * @var type
     */
    ...
    public function init() {
        ...
        $this->widgetsList = [
            [
                'classname' => WidgetIconWebMeetingMeetingHistory::class,
