...
class EventLocationController extends CrudController
{
    ...
    public function beforeAction($action)
    {
        ...
        $labelCreate = AmosEvents::t('amosevents', 'Nuova');
        $titleCreate = AmosEvents::t('amosevents', 'Crea una nuova location');
        $urlCreate = '/events/event-location/create';
        $titleSection = AmosEvents::t('amosevents', "Sedi e location evento");
