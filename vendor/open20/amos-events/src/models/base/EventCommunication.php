 ...
 * @property integer $is_changed_info
 * @property integer $search_inverval
...
class  EventCommunication extends \open20\amos\core\record\Record
{
    ...
    public function rules()
    {
        return [
            ...
            [['is_changed_info', 'event_id', 'communication_type', 'n_users', 'created_by', 'updated_by', 'deleted_by','n_sent','is_automatic'], 'integer'],
            [['title','text_email', 'subject_email'], 'string'],
            [['search_inverval', 'time_schedule_date', 'time_schedule_type', 'mailup_errors', 'sent_at', 'created_at', 'updated_at', 'deleted_at'], 'safe'],
