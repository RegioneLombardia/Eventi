...
class  EventEmailTemplates extends \open20\amos\core\record\Record
{
    ...
    public function rules()
    {
        return [
            ...
            [['webmeeting_webex_save_date_subject','webmeeting_webex_confirm_reg_subject',
                'webmeeting_webex_confirm_reg','webmeeting_webex_save_date','webmeeting_webex_subject', 'webmeeting_webex',
