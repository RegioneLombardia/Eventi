 ...
 * @property string $event_location_id
 * @property string $event_location_entrance_id
 ...
 * @property integer $original_event_id
 * @property integer $is_time_period
 ...
 * @property integer $enable_companions
 ...
 * @property integer $time_cron_executed
 ...
 * @property integer $webmeeting_webex_id
 *
...
abstract class Event extends ContentModel implements CommunityInterface
{
    ...
    const EVENTS_WORKFLOW_STATUS_SUSPENDED = 'EventWorkflow/SUSPENDED';
...
//            ['event_location_id', 'required', 'on' => self::SCENARIO_WIZARD_WHERE_AND_WHEN],
            ...
            [[
                ...
                'publish_on_poi',
                'poi_category',
                'publish_on_portale_giovani',
                'portale_giovani_category',
                'event_id',
                'manage_waiting_list',
            ...
            ['enter_time', 'match', 'pattern' => '/[0-9][0-9]:[0-9][0-9]/'],
    ...
    public function attributeLabels()
    {
        return ArrayHelper::merge(parent::attributeLabels(), [
            ...
            'numero_max_accompagnatori' => AmosEvents::t('amosevents', 'N. max partecipanti aggiuntivi'),
            ...
            'enable_companions' => AmosEvents::t('amosevents', 'Gestione partecipanti aggiuntivi'),
            'is_delegated_event' => AmosEvents::t('amosevents', 'Creazione evento in delega'),
        ]);
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getEventCommunications()
    {
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getEventAllChildren()
    {
        return $this->hasMany(\open20\amos\events\models\Event::className(), ['event_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\open20\amos\events\models\Event::className(), ['event_id' => 'id'])->andWhere(['is_time_period' => 0]);
    }

    /**
     * @return \yii\db\ActiveQuery
     */
    public function getEventTimePeriods()
    {
        return $this->hasMany(\open20\amos\events\models\Event::className(), ['event_id' => 'id'])->andWhere(['is_time_period' => 1]);
    }

    /**
     * @return \yii\db\ActiveQuery
     */
    public function getEventHighlights()
    {
        return $this->hasOne(\open20\amos\events\models\EventHighlights::className(), ['event_id' => 'id']);
    }

    /**
     * @return \yii\db\ActiveQuery
     */
    public function getWebMeetingWebex()
    {
        if (\Yii::$app->getModule('webmeeting')) {
            return $this->hasOne(\open20\webmeeting\models\WebMeetingModel::className(), ['id' => 'webmeeting_webex_id']);
        }
        return null;
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getEventInvitationSpecificUsers()
    {
        return $this->hasMany(\open20\amos\events\models\EventInvitationSpecificUsers::className(), ['event_id' => 'id']);
    }

    /**
     * @return \yii\db\ActiveQuery
     */
    public function getEventSpecificUsers()
    {
        return $this->hasMany(UserProfile::className(), ['user_id' => 'user_id'])->via('eventInvitationSpecificUsers');
    }
    ...
    {
        return $this->hasMany(\open20\amos\events\models\EventRelated::className(), ['event_id' => 'id']);
    }

    public function getCorrelatedEvents()
    {
        return $this->hasMany(\open20\amos\events\models\Event::className(), ['id' => 'related_event_id'])->via('eventRelateds');
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getEventLandingRating()
    {
        return $this->hasOne(\open20\amos\events\models\EventLandingRating::className(), ['event_id' => 'id']);
    }
