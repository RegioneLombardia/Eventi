 ...
 * @property integer $time_schedule_type
 * @property string $time_schedule_date
 * @property string $mailup_errors
 * @property string $query_sql
 * @property string $active_query_complete
...
class  EventInternalList extends \open20\amos\core\record\Record
{
    ...
    public static function getLabelStatus()
    {
        return [
            ...
            self::STATUS_ERROR =>AmosEvents::t('amosevents','Errore')
        ];
    }
    ...
    public function rules()
    {
        return [
            ...
            [['mailup_sending_id', 'mailup_message_id', 'mailup_import_id', 'mailup_group_id', 'mailup_list_id',
               'time_schedule_type', 'type', 'event_id', 'n_user_found', 'created_by', 'updated_by', 'deleted_by', 'n_sent'], 'integer'],
            [['description', 'query_sql','active_query_complete','active_query', 'search_params'], 'string'],
            [['sent_at', 'time_schedule_date', 'mailup_errors', 'status', 'created_at', 'updated_at', 'deleted_at'], 'safe'],
