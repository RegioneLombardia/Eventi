...
<div class="row">
    ...
    <div class="col-md-12">
        <?= $form->field($model, 'image')
            ->label(AmosEvents::t('amosevents', 'Immagine del protagonista')) ->widget(\open20\amos\attachments\components\CropInput::classname(), [
            'enableUploadFromGallery' => true,
...
<div class="buttons">
    <?php  echo Html::a(\open20\amos\events\AmosEvents::t('amosevents', "Annulla"),['/events/event-dashboard/landing-manage-contents','id' => $event->id], [
