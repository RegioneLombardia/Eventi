    ...
    <div id="landing-settings-div" style="<?= $hideAdvanced ?>" class="p-2 p-sm-5 neutral-1-bg-a1">
        ...
        <div class="informative-to-hide" style="<?= $strHide ?>">
            <?php if (!$disableSocial) { ?>
                ...
                <hr class="dashed">
            <?php } else {
                $eventLanding->social_reg = false;
                $eventLanding->facebook_reg = false;
                $eventLanding->twitter_reg = false;
                $eventLanding->linkedin_reg = false;
                $eventLanding->goolge_reg = false;
                $eventLanding->apple_reg = false;
                ?>
                <div hidden>
                    <?= $form->field($eventLanding, 'facebook_reg')->hiddenInput()->label('Facebook') ?>
                    <?= $form->field($eventLanding, 'twitter_reg')->hiddenInput()->label('Twitter') ?>
                    <?= $form->field($eventLanding, 'linkedin_reg')->hiddenInput()->label('Linkedin') ?>
                    <?= $form->field($eventLanding, 'goolge_reg')->hiddenInput()->label('Google') ?>
                    <?= $form->field($eventLanding, 'apple_reg')->hiddenInput()->label('Apple') ?>
                </div>
                <?php
            ...
            $hideForSPID = '';
            if ($disableSocial) {
                $hideForSPID = 'display:none';
                $eventLanding->spid_cns_reg = true;
            } ?>
            <div style="<?= $hideForSPID ?>" class="row mt-5 pt-2">
            ...
            <div class="row mt-5">
                ...
                <div class="col-md-8">
                    <?php if ($disableSocial) { ?>
                        <div hidden>
                            <?= $form->field($eventLanding, 'user_name_reg')->hiddenInput() ?>
                        </div>
                    <?php } else { ?>
                        <div class="d-flex">
                            <div class="mr-auto">
                    ...
                    <div id="register-form-fields" style="<?= $displayNone ?>">
                        <p>
                            <strong><?= AmosEvents::t('amosevents', ' Richiedi i seguenti campi opzionali') . ': ' ?></strong>
                        </p>
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <!--                                --><?php //$form->field($eventLanding, 'ask_fiscal_code')->checkbox()->label('Codice fiscale') ?>
                            ...
                            <div class="col-md-8">
                                ...
                                <!--                                --><?php //$form->field($eventLanding, 'ask_fiscal_code_required')->checkbox()->label('<i>Obbligatorio</i>') ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        if (empty($eventLanding->thank_you_registered)) {
                            $eventLanding->thank_you_registered = AmosEvents::t('amosevents', 'Ciao! Abbiamo già ricevuto la tua iscrizione all\'evento.');
                        }
