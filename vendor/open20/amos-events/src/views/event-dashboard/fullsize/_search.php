        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <?= $form->field($model, 'statusEvent')->widget(Select2::className(), [
                    'data' => [
                        Event::EVENTS_WORKFLOW_STATUS_DRAFT => \Yii::t('amosevents', "Modifica in corso"),
                        Event::EVENTS_WORKFLOW_STATUS_PUBLISHED => \Yii::t('amosevents', "Pubblicato"),
                        Event::EVENTS_WORKFLOW_STATUS_SUSPENDED => \Yii::t('amosevents', "Annullato")
                    ],
                    'language' => substr(Yii::$app->language, 0, 2),
                    'options' => [
                        'id' => 'status-event',
