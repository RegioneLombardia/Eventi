...
<div class="row">
    ...
    <div class="col-md-9">
        ...
        <?php if($eventCommunication->event->multilanguage){
            \Yii::$app->language = 'en-GB';
            $eventCommunicationEng = \open20\amos\events\models\EventCommunication::findOne($eventCommunication->id);?>
            <?php \Yii::$app->language = 'it-IT';
            ?>
            <hr>
            <p><?=$eventCommunicationEng->text_email ?></p>
        <?php } ?>
    </div>
</div>
