        ...
        <div class="col-md-7 mr-auto order-2 order-md-1">
            ...
            <div class="d-flex align-items-center mb-5">
                ...
                <div>
                    ...
                    <br>
                    <?= AmosEvents::t('amosevents', "Documenti") . ': ' . "<strong>" . $documenti . "</strong>" ?>
                    <br>
                    <?= AmosEvents::t('amosevents', "Richiesta informazioni evento") . ': ' . "<strong>" . $contact_info_organizator . "</strong>" ?>
                    <br>
...
") ?>
    ...
    <div class="buttons mt-5">
        ...
        <?= \yii\helpers\Html::submitButton(AmosEvents::t('amosevents', 'Pubblica evento'), [
