...
?>
<?php if ($model->is_time_period) { ?>
    <div class="alert alert-warning" role="alert">
        <p>
            <strong><?= AmosEvents::t('amosevents', "La community di questa fascia oraria è in comune con la community dell'evento padre") ?></strong>
            <br><?= AmosEvents::t('amosevents', "Clicca <a href='{link_info_event}'>qui</a> per modificarla.", [
                    'link_info_event' => '/events/event-dashboard/community?id=' . $model->event_id
                ]
            ) ?>
        </p>
    </div>
