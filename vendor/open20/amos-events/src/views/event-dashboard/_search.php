...
<div class="event-search my-2 collapse" id="form-search-events">
    ...
    <div class="neutral-2-bg p-4">
        <div class="row">
            ...
            <div class="col-lg-6">
                <?= $form->field($model, 'statusEvent')->widget(Select2::className(), [
                    'data' => [
                            Event::EVENTS_WORKFLOW_STATUS_DRAFT => AmosEvents::t('amosevents', "Modifica in corso"),
                            Event::EVENTS_WORKFLOW_STATUS_PUBLISHED => AmosEvents::t('amosevents', "Pubblicato"),
                            Event::EVENTS_WORKFLOW_STATUS_SUSPENDED => AmosEvents::t('amosevents', "Annullato")
                    ],
                    'language' => substr(Yii::$app->language, 0, 2),
                    'options' => [
                        'id' => 'status-event',
                ...
                ])->label(\Yii::t('amosevents',"Status")) ?>
            </div>



            <?php if (\Yii::$app->controller->action->id != 'add-to-highlights') { ?>
                <div class="col-lg-6">
                ...
                <div class="col-lg-6">
                    <?= $form->field($model, 'showTimePeriods')->checkbox([
                        'label' => AmosEvents::t('amosevents', "Visualizza fasce orarie"),
                        'class' => 'mt-5 ml-1'
                    ])->label(false); ?>
                </div>
            <?php } ?>
            ...
            <div class="col-lg-6">
                <?= $form->field($model, 'multilanguageSearch')->checkbox([
                    'label' => AmosEvents::t('amosevents', "Visualizza solo eventi multilingua"),
                    'class' => 'mt-5 ml-1'
                ])->label(false); ?>
            </div>
