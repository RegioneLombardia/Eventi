...
$templateInvitoReg = 'registration_email';
$templateConfirmReg = 'confirm_registration';
$templateSaveTheDate = 'save_the_date';

if ($model->eventType->webmeeting_webex) {
    $templateInvitoReg = 'webmeeting_webex';
    $templateConfirmReg = 'webmeeting_webex_confirm_reg';
    $templateSaveTheDate = 'webmeeting_webex_save_date';
}
...
<div class="configura-email">
        ...
        <div class="py-4 d-flex title-substeps affix-top">
            ...
            <h5 class="font-weight-bold ">
                ...
                <a href="#" data-toggle="tooltip" data-html="true"
                   title=" <?= AmosEvents::t('amosevents', "Puoi scegliere il <strong>colore</strong> da abbinare alla grafica e alla foto di copertina che hai scelto, per personalizzare al meglio il tuo evento.") ?>">
                ...
                <div class="row variable-gutters">
                    <div class="col-md-6">
                        <?= $this->render('@vendor/open20/amos-events/src/views/event-dashboard/_parts/_item_email_template', [
                            ...
                            'form' => $form,
                            'attribute_text' => $templateSaveTheDate,
                            'attribute_subject' => $templateSaveTheDate . '_subject',
                    ...
                    if ($model->eventType->event_type != \open20\amos\events\models\EventType::TYPE_INFORMATIVE) { ?>
                        <div class="col-md-6 mt-5 mt-md-0">
                            <?= $this->render('@vendor/open20/amos-events/src/views/event-dashboard/_parts/_item_email_template', [
                                'emailTemplates' => $emailTemplates,
                                'form' => $form,
                                'attribute_text' => $templateInvitoReg,
                                'attribute_subject' => $templateInvitoReg . '_subject',
    ...
    <div class="buttons row">
        <!--        --><?php //WizardPrevAndContinueButtonWidget::widget([
        //            'model' => $model,
        ...
        <div class="bk-btnFormContainer col-xs-12 nop">
            <div class="col-sm-6 nop">
                <a class="btn btn-action-primary pull-left wizard-link-btn"
                   href="<?= Yii::$app->getUrlManager()->createUrl(['/events/wizard/base-info', 'id' => $model->id]) ?>">Indietro</a>
            </div>
            <div class="col-sm-6 nop">

                <button type="submit" class="btn btn-primary pull-right wizard-widget-continue-btn"><?= AmosEvents::t('events', "Prosegui") ?></button>
