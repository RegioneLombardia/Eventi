                           ...
                           <div class="rss-head col-xs-12">
                            <h2><?= str_replace('-', ' ', strtoupper($cat)) ?></h2>
                                ...
                                if (isset($link) && !empty($link)):
                                    ...
                                    <?=
                                    Html::a(
                                            Module::t('amosrss', '#readmore') . AmosIcons::show('arrow-right'), Url::to($link[0], true), ['target' => '_blank', 'title' => Module::t('amosrss', '#readmore')]
                                    );
                                ?>
                            <?php
                            endif;
                            ...
                            foreach ($feeds as $feed):
                                foreach ($feed as $count => $element):
                                    ...
                                    <div class="single-item col-xs-12" role="option">
                                        ...
                                        <?=
                                        Html::a(
                                            $title . ' ' . AmosIcons::show('open-in-new', [], AmosIcons::AM) , Url::to($element->getLink(), true), ['target' => '_blank', 'title' => $title, 'class' => 'title']
                                        );
                                        ?>
                                        <p class="text">
                                            <?php
