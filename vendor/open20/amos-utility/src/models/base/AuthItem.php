...
class  AuthItem extends \open20\amos\core\record\Record
{
    ...
    {
        return $this->hasMany(\open20\amos\utility\models\CwhTagInterestMm::className(), ['auth_item' => 'name']);
    }
    ...
    {
        return $this->hasMany(\open20\amos\utility\models\TagModelsAuthItemsMm::className(), ['auth_item' => 'name']);
    }
}
