...
if ($sondaggio->frontend == 1 && !$sondaggioLive) {
    echo "<?php \n"
...
<div class="sondaggi-compilazione pagid-<?= $pagina->id ?>">
    ...
    <div class="sondaggi-form">
        ...
        <div class="m-b-25" style="display:none; color: red;" id="sondaggiolive_error"><?=
            \Yii::t('amossondaggi', 'E\' necessario selezionare una risposta per votare')
            ?></div>
    ...
    <div id="form-actions" class="bk-btnFormContainer" <?= ($sondaggioLive ? 'style="display: block;"' : '') ?> >
        ...
        if ($sondaggioLive) {
            ...
            echo "<?php
                ...
                <?=
                Html::a(AmosSondaggi::t('amossondaggi', 'Chiudi'), " . (!empty($urlSondaggio) ? "'$urlSondaggio'" : "['/sondaggi/pubblicazione/index']") . ", [
