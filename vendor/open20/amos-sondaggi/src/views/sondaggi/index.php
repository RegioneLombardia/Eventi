        ...
        if($(this).data('dont')!=1){
            ...
            $.ajax({
                ...
                success:function(result){
                    ...
                    element.data('dont',1 );
                    element.children(":first").removeClass("am-download");
                    element.children(":first").addClass("am-block");
        ...
        $.ajax({
            ...
            success:function(result){
                ...
                if(dati['status'] == 3){
                    ...
                    $(that).data('element').children(":first").addClass("am-download");
                    $(that).data('element').children(":first").removeClass("am-block");
                ...
                [
                    ...
                    'anteprima' => function ($url, $model) {
                        ...
                        'risultati' => function ($url, $model) {
                            ...
                            if (\Yii::$app->getUser()->can('AMMINISTRAZIONE_SONDAGGI') && $partecipazioni) {
