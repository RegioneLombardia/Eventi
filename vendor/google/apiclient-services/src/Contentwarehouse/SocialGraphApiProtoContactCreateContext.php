...
class SocialGraphApiProtoContactCreateContext extends \Google\Model
{
...
class_alias(SocialGraphApiProtoContactCreateContext::class, 'Google_Service_Contentwarehouse_SocialGraphApiProtoContactCreateContext');
