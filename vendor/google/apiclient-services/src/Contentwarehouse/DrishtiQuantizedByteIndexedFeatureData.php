...
class DrishtiQuantizedByteIndexedFeatureData extends \Google\Collection
{
...
class_alias(DrishtiQuantizedByteIndexedFeatureData::class, 'Google_Service_Contentwarehouse_DrishtiQuantizedByteIndexedFeatureData');
