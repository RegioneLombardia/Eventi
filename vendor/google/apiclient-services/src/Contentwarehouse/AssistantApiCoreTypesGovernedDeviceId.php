...
class AssistantApiCoreTypesGovernedDeviceId extends \Google\Model
{
  /**
   * @var string
   */
  ...
  protected $deviceConfigType = AssistantApiCoreTypesGovernedDeviceConfig::class;
  ...
  /**
   * @param AssistantApiCoreTypesGovernedDeviceConfig
   */
  public function setDeviceConfig(AssistantApiCoreTypesGovernedDeviceConfig $deviceConfig)
  {
    $this->deviceConfig = $deviceConfig;
  }
  /**
   * @return AssistantApiCoreTypesGovernedDeviceConfig
   */
...
class_alias(AssistantApiCoreTypesGovernedDeviceId::class, 'Google_Service_Contentwarehouse_AssistantApiCoreTypesGovernedDeviceId');
