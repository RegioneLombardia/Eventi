...
class SocialCommonSearchLinkData extends \Google\Model
{
  /**
   * @var float
   */
...
class_alias(SocialCommonSearchLinkData::class, 'Google_Service_Contentwarehouse_SocialCommonSearchLinkData');
