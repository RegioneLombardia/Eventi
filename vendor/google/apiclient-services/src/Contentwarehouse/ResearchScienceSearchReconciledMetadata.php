...
class ResearchScienceSearchReconciledMetadata extends \Google\Collection
{
   ...
   */
  public $languageCode;
  protected $proscriptionType = ResearchScienceSearchProscription::class;
  protected $proscriptionDataType = 'array';
  /**
   * @var string[]
   */
  public $proscriptionDeprecated;
  /**
   * @var string[]
   */
  ...
  /**
   * @param ResearchScienceSearchProscription[]
   */
  ...
  /**
   * @return ResearchScienceSearchProscription[]
   */
   ...
   * @param string[]
   */
  public function setProscriptionDeprecated($proscriptionDeprecated)
  {
    $this->proscriptionDeprecated = $proscriptionDeprecated;
  }
  /**
   * @return string[]
   */
  public function getProscriptionDeprecated()
  {
    return $this->proscriptionDeprecated;
  }
  /**
   * @param string[]
   */
