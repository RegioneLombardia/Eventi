...
class m211109_104613_fix_widgets_for_community extends Migration
{
    ...
    public function safeUp()
    {
         ...
         $this->update(self::TABLE, ['status' => 0], ['classname' => 'open20\amos\news\widgets\graphics\WidgetGraphicsCmsUltimeNews','module'=> 'news' ]);
        $this->update(self::TABLE, ['status' => 0], ['classname' => 'open20\amos\documenti\widgets\graphics\WidgetGraphicsCmsUltimiDocumenti','module'=> 'news' ]);
        $this->update(self::TABLE, ['status' => 0], ['classname' => 'open20\amos\discussioni\widgets\graphics\WidgetGraphicsCmsUltimeDiscussioni','module'=> 'news' ]);
        $this->update(self::TABLE, ['status' => 0], ['classname' => 'open20\amos\discussioni\widgets\graphics\WidgetGraphicsCmsAllDiscussioni','module'=> 'news' ]);
    ...
    public function safeDown()
    {
        ...
        $this->update(self::TABLE, ['status' => 1], ['classname' => 'open20\amos\news\widgets\graphics\WidgetGraphicsCmsUltimeNews','module'=> 'news' ]);
        $this->update(self::TABLE, ['status' => 1], ['classname' => 'open20\amos\documenti\widgets\graphics\WidgetGraphicsCmsUltimiDocumenti','module'=> 'news' ]);
        $this->update(self::TABLE, ['status' => 1], ['classname' => 'open20\amos\discussioni\widgets\graphics\WidgetGraphicsCmsUltimeDiscussioni','module'=> 'news' ]);
        $this->update(self::TABLE, ['status' => 1], ['classname' => 'open20\amos\discussioni\widgets\graphics\WidgetGraphicsCmsAllDiscussioni','module'=> 'news' ]);
